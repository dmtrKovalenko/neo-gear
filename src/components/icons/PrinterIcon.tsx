...
export function PrinterIcon({ className, size = 24 }: PrinterIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <g>
        <path
          d="M470,120c11.028,0,20-8.972,20-20V20c0-11.028-8.972-20-20-20H20C8.972,0,0,8.972,0,20v80c0,11.028,8.972,20,20,20h15
        ...
        />
        <path
          d="M290,35h-90c-5.523,0-10,4.478-10,10v30c0,5.523,4.477,10,10,10h90c5.522,0,10-4.477,10-10V45
